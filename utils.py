...
def generate_examples(mode, texts, labels):
    examples = []
...
def save_cp(args, batch_size, epochs, steps, model, optimizer, scheduler, tokenizer):
    save_dir_path = args.output_dir + 'checkpoint-{}_{}_{}/'.format(batch_size, epochs, steps)
